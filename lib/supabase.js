...
export async function updateClient(id, updates) {
  const clean = {};
  const allowed = ['name', 'email', 'phone', 'company', 'business_type', 'platforms', 'prompt', 'notes', 'catalog', 'logo', 'catalog_filename', 'api_key', 'api_model', 'gemini_api_key', 'whisper_api_key', 'meta_token', 'meta_page_id', 'meta_verify_token', 'bot_capabilities', 'pricing', 'auto_images'];
